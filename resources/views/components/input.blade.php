<div id="{{ $id }}" class="input relative">
    ...
    <input id="{{ $inputId }}" class="border my-1  cursor-pointer border-slate-300 rounded w-full px-3 py-2" type="text" placeholder="{{ $placeholder }}" style="caret-color:transparent;" readonly>
