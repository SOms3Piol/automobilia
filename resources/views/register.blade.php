...
<body>
    ...
    <section class="h-screen w-full bg-slate-200 flex justify-center items-center" >
         <form action="{{ route('user.create') }}"  class="bg-white py-8 px-3 rounded-xl basis-128 flex flex-col gap-5 text-slate-600 shadow-2xl " >
            @csrf  
         <h2 class="text-2xl font-semibold text-center" >Register Account</h2>   
         <div class="flex flex-col gap-3" >
                <label for="email">Name</label>
                <input class=" px-3 py-2 rounded border outline-none border-slate-500 focus:border-blue-700" type="text" name="name" placeholder="Email">
            </div>
            <div class="flex flex-col gap-3" >
            ...
            <div class="flex flex-col gap-3" >
                ...
                <input class=" px-3 py-2 rounded border outline-none border-slate-500 focus:border-blue-700" type="password" placeholder="Confirm password">
            </div>
